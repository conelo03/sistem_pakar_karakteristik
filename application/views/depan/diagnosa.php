...
<div class="container">
  <div class="jumbotron jumbotron-fluid" style="background: slateblue;">
    <div class="container">
      ...
      <p class="lead">Lakukan Sekarang!</p>
    </div>
  </div>

  <div class="card">
    <div class="card-header">
      <h1 class="h4 text-gray-900">Silahkan lengkapi form biodata</h1>
    </div>
    <div class="card-body">
      <div class="row">
        <div class="col-lg-12">
          <div class="p-2">
            <div class="text-center">
              <form action="<?= base_url() ?>HalamanUser/simpan_riwayat" method="post" class="user">
                ...
                <button class="btn btn-dark btn-user btn-block" type="submit">Mulai Tes</button>
